...
public class SongAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.artworkHolder.setImageDrawable(null);  // Clear previous image

        if (artworkUri != null) {
            viewHolder.artworkHolder.setImageURI(artworkUri);
            if (viewHolder.artworkHolder.getDrawable() == null) {
                // If loading failed, set the default background
                viewHolder.artworkHolder.setImageResource(R.drawable.asphire_logo);
            }
        } else {
            viewHolder.artworkHolder.setImageResource(R.drawable.default_artwork_background);
        }


        // Prepare the player with the selected song
